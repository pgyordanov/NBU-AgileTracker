namespace AgileTracker.TasksService.Application.Features.Queries.GetMemberSprint
{
    ...
    public class SprintTaskOutputModel: IMapFrom<Task>
    {
        ...
        public SprintTaskStatusOutputModel Status { get; private set; } = default!;
        ...
        {
            mapping.CreateMap<Task, SprintTaskOutputModel>()
