namespace AgileTracker.Common.Domain
{
    using System;
    ...
    public static class Guard
    {
        ...
        public static void AgainstEmptyStringAllowNull<TException>(string? value, string name = "Value")
            where TException : BaseDomainException, new()
        {
            if (value == null)
            {
            ...
            where TException : BaseDomainException, new()
        {
            ...
            ThrowException<TException>($"{name} must be {minLength} and {maxLength} symbols.");
        }
